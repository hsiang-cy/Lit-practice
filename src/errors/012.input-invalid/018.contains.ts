...
const errorTypeCode = '012.018'
const errorName = 'Input Invalid - contains'
...
const generateInputInvalidError = GenerateErrorObjectWithTemplate(ErrorCodes, errorParse, i18n.t('errors:012.018.defaultMessage'))
