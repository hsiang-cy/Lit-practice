...
const errorTypeCode = '012.003'
const errorName = 'Input Invalid - is date'
...
const generateInputInvalidError = GenerateErrorObjectWithTemplate(ErrorCodes, errorParse, i18n.t('errors:012.003.defaultMessage'))
