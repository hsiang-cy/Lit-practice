...
const errorTypeCode = '012.029'
const errorName = 'Input Invalid - array not contains'
...
const generateInputInvalidError = GenerateErrorObjectWithTemplate(ErrorCodes, errorParse, i18n.t('errors:012.029.defaultMessage'))

export const arrayNotContains = {
  ...generateInputInvalidError
}

export default arrayNotContains
