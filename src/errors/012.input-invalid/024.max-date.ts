...
const errorTypeCode = '012.024'
const errorName = 'Input Invalid - max date'
...
const generateInputInvalidError = GenerateErrorObjectWithTemplate(ErrorCodes, errorParse, i18n.t('errors:012.024.defaultMessage'))
