...
const errorTypeCode = '012.017'
const errorName = 'Input Invalid - is longitude'
...
const generateInputInvalidError = GenerateErrorObjectWithTemplate(ErrorCodes, errorParse, i18n.t('errors:012.017.defaultMessage'))
