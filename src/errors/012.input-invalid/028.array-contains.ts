...
const errorTypeCode = '012.028'
const errorName = 'Input Invalid - array contains'
...
const generateInputInvalidError = GenerateErrorObjectWithTemplate(ErrorCodes, errorParse, i18n.t('errors:012.028.defaultMessage'))
