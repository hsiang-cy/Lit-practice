...
const errorTypeCode = '012.023'
const errorName = 'Input Invalid - min date'
...
const generateInputInvalidError = GenerateErrorObjectWithTemplate(ErrorCodes, errorParse, i18n.t('errors:012.023.defaultMessage'))
