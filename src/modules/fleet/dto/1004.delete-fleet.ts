 ...
 * LastEditTime: 2025-01-08 15:34:02
 * @Description:
 */
...
class DeleteFleetQuery extends BaseQuery {
  @ApiProperty({ description: i18n.t('modules:fleet.1004.id'), maxLength: 32, example: '160793803800350720' })
  @Trim()
  @MaxLength(32)
  @IsString()
  @IsNotEmpty()
...
const CombineSwaggerDecorators = () => {
  return applyDecorators(
    ApiTags('Fleet'),
    ApiBearerAuth(),
    ApiOperation({ description: i18n.t('modules:fleet.1004.apiDescription'), operationId: 'DeleteFleet' }),
