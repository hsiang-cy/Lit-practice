 ...
 * LastEditTime: 2025-01-21 15:16:44
 * @Description:
 */
...
class UpdateVehicleStatusBody {
  @ApiProperty({ description: i18n.t('modules:vehicle.2007.id'), maxLength: 32, example: '160793803800350720' })
  @Trim()
  @MaxLength(32)
  @IsString()
  @IsNotEmpty()
  ...
  @ApiProperty({
    description: handleEnumDescription(i18n.t('modules:vehicle.2007.status')),
...
const CombineSwaggerDecorators = () => {
  return applyDecorators(
    ApiTags('Vehicle'),
    ApiBearerAuth(),
    ApiOperation({ description: i18n.t('modules:vehicle.2007.apiDescription'), operationId: 'UpdateVehicleStatus' }),
...
export {
  UpdateVehicleStatusBody as Body,
