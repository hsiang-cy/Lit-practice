...
const errorTypeCode = '012.025'
const errorName = 'Input Invalid - min length'
...
const generateInputInvalidError = GenerateErrorObjectWithTemplate(ErrorCodes, errorParse, i18n.t('errors:012.025.defaultMessage'))
